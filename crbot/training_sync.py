...
class ReplaySync:
    ...
    def compatibility(self, replay_config: dict[str, Any] | None = None) -> str:
        ...
        for name in ("replay_learning.py", "replay.py", "replay_evaluation.py", "imitation.py", "cards.py", "battle_perception.py", "policy.py", "tactics.py", "action_feedback.py", "learned_perception.py", "action_confirmation.py", "temporal.py"):
